...
class WelcomeMessageCommand extends Command {
  constructor (client) {
    super(client, {
      ...
      description: '`<Message>` Set the message the user gets when they join your server. This is only shown to verified members. Available replacements can be seen at https://rover.link/manual. Default: Welcome to %SERVER%, %USERNAME%!.',
